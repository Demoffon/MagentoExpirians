<?php
class Virtual_Orders_Adminhtml_BazController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function editAction()
    {
        ...
        $model = Mage::getModel('virtual_orders/baz');
        ...
        $this->_initAction()
            ...
            ->_addContent($this->getLayout()->createBlock('virtual_orders/adminhtml_baz_edit')->setData('action', $this->getUrl('*/*/save')))
            ->renderLayout();
    }
    ...
    public function saveAction()
    {
        if ($postData = $this->getRequest()->getPost()) {
            $model = Mage::getSingleton('virtual_orders/baz');
    ...
    {
        $data = Mage::getModel('virtual_orders/baz')->load($this->getRequest()->getParam('id'));
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('sales/virtual_orders_baz');
    }
}